...
- **Tidy PR after Phase 0 lands:** dead `!CAPS.rbac` arms (listed above), dead "Enterprise" copy behind `isLocked()` in the policy editor and workspace card, stale CI comments.
