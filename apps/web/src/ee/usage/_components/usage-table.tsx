...
import type { UsageAgentRow } from "@/lib/api/usage";
...
// The bar is a SHARE-OF-TOTAL indicator, deliberately not a spend-vs-cap
// meter: there is no cap to approach and no amount to overspend here.
const BAR_CLASSES =
  "bg-muted h-1.5 [&>[data-slot=progress-indicator]]:bg-brand";

export const UsageTable = ({ agents, totalRequests }: UsageTableProps) => (
