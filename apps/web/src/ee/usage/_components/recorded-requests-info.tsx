 ...
 * decision. A pass-through on an agent's own key is never recorded, so the
 * number below the title is a floor, not a total. The card says "recorded
 * gateway requests" and this explains the gap.
 *
